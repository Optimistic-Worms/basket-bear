...
const { getLowestPrices, updateProduct, getPriceData, getAllProducts } = require('./controllers/product');
...
apiRoutes.get('/products', apiAuth.authenticateToken, getAllProducts);
